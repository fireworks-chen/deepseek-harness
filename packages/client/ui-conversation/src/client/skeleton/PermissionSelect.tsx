...
/** Kebab-case custom preset names use title case when no localized built-in label exists. */
        ...
        anchor={
          <button
            ...
            aria-label={t('input.accessMode', {
              name: permissionLabel(currentValue, current?.name ?? currentValue, t),
            })}
          ...
          >
            ...
            <span className={css.triggerLabel}>
              {permissionLabel(currentValue, current?.name ?? currentValue, t)}
            </span>
